...
def create_app(test_config=None):
    ...
    makedirs('./aguiartransportes/flaskr/downloadfile',exist_ok=True)
    makedirs('./aguiartransportes/flaskr/templates/prochtml',exist_ok=True)

    #Views
    app.register_blueprint(clientform.bp)
    app.register_blueprint(clientformphone.bp)
    app.register_blueprint(downloadfile.bp)
    app.register_blueprint(downloadpdf.bp)
    app.register_blueprint(downloadcsvempresa.bp)
    app.register_blueprint(home.bp)
    app.register_blueprint(homephone.bp)
